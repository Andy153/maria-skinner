...
export const pasteleriaProducts: Product[] = [
  {
    ...
    name: "Torta Brownie",
    description:
      "Base de chocolate, dulce de leche y merengue italiano. Sin harina.",
    price: "$40.000",
    category: "Tortas",
  },
  {
  ...
  },
  {
    ...
    description:
      "Base de chocolate y mousse de chocolate. Sin harina.",
    price: "$40.000",
    category: "Tortas",
  },
  {
  ...
  },
  {
    ...
    description: "Torta húmeda de manzana.",
    price: "$40.000",
    category: "Tortas",
  },
  {
    ...
    description:
      "Base de chocolate y mousse de menta. Sin harina.",
    price: "$40.000",
    category: "Tortas",
  },
  {
...
export const decoProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Set de 3 medallones para identificar termos y jarras. No incluye el termo.",
    price: "$20.000",
    category: "Medallones",
  },
  {
    id: "vajilla-piezas-rosas",
    image: "/images/productos/dulceras-azucareras-rosas.jpg",
    tag: "Vajilla",
    name: "Piezas de porcelana con rosas",
    description: "Dulceras, azucareras y lecheras de porcelana con rosas pintadas.",
    price: "$12.000 c/u",
    category: "Vajilla para la mesa del té",
  },
  {
    id: "vajilla-plato-rosas",
    image: "/images/productos/plato-torta-rosas.jpg",
    tag: "Vajilla",
    name: "Plato de porcelana con rosas",
  ...
  {
    id: "vajilla-bowls-chicos",
    image: "/images/productos/bols-medianos-olivas.jpg",
    tag: "Vajilla",
    name: "Bowls chicos",
    description: "Bowls de cerámica con diseño de olivas. 11 cm de diámetro.",
    price: "$4.000 c/u",
    category: "Vajilla para la mesa del té",
  },
  {
    id: "vajilla-bowls-medianos",
  ...
  {
    id: "set-cocina-masitas",
    image: "/images/productos/set-cocina-masitas.jpg",
    tag: "Infantil",
    name: "A cocinar masitas",
    description: "Set de cocina para chicos con rodillo, cortantes y recetas.",
    price: "$35.000",
    category: "Sets de cocina para chicos",
  },
  {
    id: "set-cocina-masitas-chupetin",
    image: "/images/productos/set-cocina-masitas-chupetin.jpg",
    tag: "Infantil",
    name: "A cocinar masitas chupetín",
    description: "Set de cocina para chicos con rodillo, cortantes y recetas.",
    price: "$35.000",
    category: "Sets de cocina para chicos",
  },
  {
    id: "set-cocina-muffins",
    image: "/images/productos/set-cocina-muffins.jpg",
    tag: "Infantil",
    name: "A cocinar muffins",
    description: "Set de cocina para chicos con utensilios y recetas.",
    price: "$35.000",
    category: "Sets de cocina para chicos",
  },
  {
    id: "set-cocina-noquis",
    image: "/images/productos/set-cocina-noquis.jpg",
    tag: "Infantil",
    name: "A cocinar ñoquis",
    description: "Set de cocina para chicos con utensilios y recetas.",
    price: "$35.000",
    category: "Sets de cocina para chicos",
  },
  {
    id: "set-cocina-budines",
    image: "/images/productos/IMG-20260701-WA0024.jpg",
    images: [
      "/images/productos/IMG-20260701-WA0024.jpg",
      "/images/productos/IMG-20260701-WA0026.jpg",
    ],
    tag: "Infantil",
    name: "A cocinar Budines",
    description: "Set de cocinar para chicos con utensilios y receta.",
    price: "$35.000",
    category: "Sets de cocina para chicos",
  },
  {
    id: "set-cocina-tortas",
    image: "/images/productos/IMG-20260701-WA0025.jpg",
    images: [
      "/images/productos/IMG-20260701-WA0025.jpg",
      "/images/productos/IMG-20260701-WA0023.jpg",
    ],
    tag: "Infantil",
    name: "A cocinar Tortas",
    description:
      "Set de cocina para chicos con utensilios, delantal y receta.",
    price: "$45.000",
    category: "Sets de cocina para chicos",
  },
];
